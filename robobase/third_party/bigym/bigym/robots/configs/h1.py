...
from bigym.robots.configs.robotiq import ROBOTIQ_2F85, ROBOTIQ_2F85_FINE_MANIPULATION,ROBOTIQ_2F85_HIGH_GAIN,ROBOTIQ_2F85_HIGH_GAIN_FINE_MANIPULATION
...
H1_HIGH_GAIN_CONFIG = RobotConfig(
    model=ASSETS_PATH / "h1/h1.xml",
    delta_range=(-0.1, 0.1),
    position_kp=300,
    pelvis_body="pelvis",
    floating_base=H1_FLOATING_BASE,
    gripper=ROBOTIQ_2F85_HIGH_GAIN,
    arms={HandSide.LEFT: H1_LEFT_ARM, HandSide.RIGHT: H1_RIGHT_ARM},
    actuators=H1_ACTUATORS,
    cameras=["head", "left_wrist", "right_wrist"],
    namespaces_to_remove=["light"],
)
H1_HIGH_GAIN_FINE_MANIPULATION_CONFIG = RobotConfig(
    model=ASSETS_PATH / "h1/h1.xml",
    delta_range=(-0.1, 0.1),
    position_kp=300,
    pelvis_body="pelvis",
    floating_base=H1_FLOATING_BASE,
    gripper=ROBOTIQ_2F85_HIGH_GAIN_FINE_MANIPULATION,
    arms={HandSide.LEFT: H1_LEFT_ARM, HandSide.RIGHT: H1_RIGHT_ARM},
    actuators=H1_ACTUATORS,
    cameras=["head", "left_wrist", "right_wrist"],
    namespaces_to_remove=["light"],
...
class H1_HIGH_GAIN(Robot):
    """H1 Robot."""

    @property
    def config(self) -> RobotConfig:
        """Get robot config."""
        return H1_HIGH_GAIN_CONFIG
